...
const Login = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col h-screen items-center justify-center gap-5 md:gap-16  px-5 sm:px-10 md:p-0 mx-auto md:w-1/2"
    >
      <div className="text-center">
        <H1>Login</H1>
      </div>
      <div className="space-y-3 md:space-y-6 lg:space-y-10 w-full md:w-1/2">
        {isLoading && (
